...
CREATE TABLE PurchaseTransaction(
	...
	BionicStock INT FOREIGN KEY REFERENCES Bionic(BionicStock) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL
);
...
CREATE TABLE PurchaseTransactionDetail(
	...
	BionicID CHAR(5) FOREIGN KEY REFERENCES PurchaseTransaction(BionicID) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
...
CREATE TABLE SalesTransactionDetail(
	...
	BionicID CHAR(5) FOREIGN KEY REFERENCES SalesTransaction(BionicID) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
